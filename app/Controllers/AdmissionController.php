...
class AdmissionController extends BaseController
{
	...
	public function insertStudentAdmissionForwarded($id)
	{
		...
		if (!empty($_POST['cert_dry_sealID_twelve'])) {
			$cert_dry_sealID_twelve = $_POST['cert_dry_sealID_twelve'];}else{$cert_dry_sealID_twelve = 0;}
		...
		if (!empty($is_result)) {
			$res = $insertstudentadmission->updateAdmissionStudents($userID, $sar_pupcct_resultID, $f137ID, $f138ID, $psa_nsoID, $good_moralID, $medical_certID, $picture_two_by_twoID, $nc_non_enrollmentID, $coc_hs_shsID, $ac_pept_alsID, $cert_dry_sealID, $cert_dry_sealID_twelve, $admission_status);
		}else{
			$res = $insertstudentadmission->insertAdmissionStudents($userID, $sar_pupcct_resultID, $f137ID, $f138ID, $psa_nsoID, $good_moralID, $medical_certID, $picture_two_by_twoID, $nc_non_enrollmentID, $coc_hs_shsID, $ac_pept_alsID, $cert_dry_sealID, $cert_dry_sealID_twelve, $admission_status);
		}
