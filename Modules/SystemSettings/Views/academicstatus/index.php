        ...
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
          <li class="nav-item" role="presentation">
            <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">
              <i class="fas fa-spinner"></i> Academic Status
            </button>
          </li>
          <li class="nav-item" role="presentation">
            ...
            <div class="card">
              <div class="card-body">
                <div class="container-fluid p-1">
                  ...
                  <div class="row mb-3">
                    <div class="col-md-6">
                      <small class="text-muted">System Settings | Academic Status</small>
                      <h2>Recycle Bin</h2>
                    </div>
                  </div>
                  <div class="row">
                            ...
                            <?php if (!empty($academic_statuses)): ?>
                              <?php foreach ($academic_statuses as $acdemic_status): ?>
                                <tr>
                                  ...
                                  <td>Date</td>
                                  <td class="text-center">
                                    <?=esc(buttons($allPermissions, ['restore-academic-status'], 'academic-status', $acdemic_status['id']))?>
                                  </td>
                                </tr>
                              <?php endforeach; ?>
                            <?php endif; ?>
