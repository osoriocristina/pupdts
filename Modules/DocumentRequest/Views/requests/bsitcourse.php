    ...
    <div class="row header-top">
      <div class="col-md-12">
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
           ...
           <a href="/approval"><i class="fas fa-arrow-left fa-2x" style="margin: 10px"></i></a>
              ...
              <div class="card-body">
                <div class="container-fluid p-1">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                      <a href="students/add" class="float-end btn-primary btn-add"><i class="fas fa-plus-square"></i> Add Student</a>
                    </div>
                  </div>
                    <div class="row">
                      <div class="col-md-5">
                      ...
                      <div class="col-md-2">
                        <button onClick='insertSpreadsheet()' class="btn btn-primary">Upload file</button>
                      </div>
                            ...
                            <?php if (!empty($students)): ?>
                              <?php foreach ($students as $student): ?>
                                <tr>                                 
                                  ...
                                  <td><?=ucwords(esc($student['submission_status']))?></td>     
                                  <td>
                                  <a class="dropdown-item" href="#" id="credentialsModal" data-bs-toggle="modal" data-bs-target="#credentialsForm" >View History</a>
                                  </td>
